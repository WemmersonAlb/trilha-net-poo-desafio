namespace DesafioPOO.Models
{
    ...
    public class Nokia : Smartphone
    {
        ...
        public override void InstalarAplicativo(string nomeApp)
        {
            ...
            Console.WriteLine($"O aplicativo {nomeApp} foi instalado com sucesso!!!");           throw new NotImplementedException();
        }
        //Extras
        ...
        public override void ListarAplicativos()
        {
            ...
            Console.WriteLine($"\nExistem {AppsInstalados.Count()} aplicativos instalados em seu Nokia.");
        }
        public override void InstalarAplicativoPelaLojaDeApps(){
            Console.WriteLine("         Boas Vindas a PlayStore!!!          \n\n");
